...
describe('Shape Classes', () => {
    ...
    <text x="50%" y="130" font-size="85px" dominant-baseline="middle" text-anchor="middle" fill="#000220">abc</text>
</svg>`
    ...
    <text x="50%" y="130" font-size="85px" dominant-baseline="middle" text-anchor="middle" fill="yellow">BEE</text>
</svg>`
